...
var dbURI = "mongodb://localhost/DebtSettler";
if (process.env.NODE_ENV === "docker") {
    dbURI = "mongodb://debtsettler-mongodb/DebtSettler";
}
mongoose.connect(dbURI);

//Spremljanje napak povezovanja na podatkovno bazo
...
//Spremljanje napak pri zapiranju povezave
